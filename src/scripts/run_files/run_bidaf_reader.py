...
bidaf_config = {"objective_variant": "independent",  # independent joint independent_joint
                "batch_size": 40,
                "decoding_variant": "independent_filtered",
                ...
                'dropout_rate': 0.28538318395847156,
                'epochs': 14,
                'learning_rate': 0.003585643883539457,
                'scheduler': 'linear',
                'true_batch_size': 80,
