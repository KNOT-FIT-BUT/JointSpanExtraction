...
class TransformerForQuestionAnsweringIndepJoint(torch.nn.Module):
    ...
    def __init__(self, config, sep_token_id, pad_token_id, keep_cls_level_output, model_clz=BertModel,
        ...
        # weights for computing joint probabilities
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, position_ids=None, head_mask=None):
        ...
        joint_logits = TransformerForQuestionAnsweringJoint.compute_joint_scores(self, sequence_output)
        # joint_logits shape: batch x seq_len x seq_len
        if self.masking:
